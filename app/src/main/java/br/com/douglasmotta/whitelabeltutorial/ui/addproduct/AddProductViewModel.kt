...
class AddProductViewModel @Inject constructor(
    ...
    val imageUriErrorResId = _imageUriErrorResId

    private val _descriptionFieldErrorResId = MutableLiveData<Int>()
    val descriptionFieldErrorResId = _descriptionFieldErrorResId

    private val _priceFieldErrorResId = MutableLiveData<Int>()
    val priceFieldErrorResId = _priceFieldErrorResId

    private val _productCreated = MutableLiveData<Product>()
    val productCreated = _productCreated
